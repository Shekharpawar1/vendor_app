        ...
        children: [
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final rt = controller.reservationTitles[index];
              return Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              reservation.info2 != null && reservation.info2.isNotEmpty?
                              Row(
                                children: [
                                  Text('${rt.subTitle2}: '),
                                  Text('${reservation.info2},'),
                                ],
                              ):SizedBox.shrink(),
                              SizedBox(width: 5),
                              reservation.info3 != null && reservation.info3.isNotEmpty?
                              Row(
                                children: [
                                  Text('${rt.subTitle3}: '),
                                  Text(reservation.info3),
                                ],
                              ):SizedBox.shrink(),
                            ],
                          ),

                          reservation.info4 != null && reservation.info4.isNotEmpty
                              ? Row(
                            children: [
                              Text('${rt.subTitle4}: '),
                              Text(reservation.info4),
                            ],
                          )
                              : SizedBox.shrink(),
                          SizedBox(height: 10),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  SizedBox(width: 4),
                                  Text(reservation.someOtherInfo),
                                ],
                              ),
                            ],
                          ),
