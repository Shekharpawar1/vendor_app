...
class BookingDetails extends StatefulWidget {
  ...
  BookingDetails({super.key, required this.BookingId, required this.BookingNumber});
...
class _BookingDetailsState extends State<BookingDetails> {
  ...
  void initState() {
    ...
    controller = Get.put(CommonAppBar2Controller(widget.BookingId, widget.BookingNumber));
  }
  @override
