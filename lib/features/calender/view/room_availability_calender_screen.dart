      ...
      child: Obx(() {
        return ListView(
          children: controller.roomTypes.map((roomType) {
            ...
            //         spacing: 16.0, // Horizontal spacing between children
            //         runSpacing: 8.0, // Vertical spacing between rows
            //         children: details.map<Widget>((detail) {
            //           return Container(
            //             width:  Get.width, // Adjust width based on spacing
              ...
              children: [
                SingleChildScrollView(
                  ...
                  child: Row(
                    children: details.map<Widget>((detail) {
                      return InkWell(
                        onTap:()=>Get.toNamed("/bookingList"),
                        child: Container(
                          width: Get.width*.45, // Adjust width based on spacing
