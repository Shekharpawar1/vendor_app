...
class BookingBottomSheet {
  ...
  BookingBottomSheet({
    ...
    required this.title, required this.bookingNumber,
  });
            ...
            child: Wrap(
              children: [
                ListTile(
                  ...
                  onTap: () {
                    print('Booking Id2:$bookingId');
                    Get.to(() => BookingDetails(BookingId: bookingId, BookingNumber: bookingNumber));
                  },
                ),
                ListTile(
                  leading: FaIcon(
            ...
            child: Wrap(
              children: [
                ListTile(
                  ...
                  onTap: () {
                    Get.to(() => BookingDetails(BookingId: bookingId, BookingNumber: bookingNumber,));
                    print('Booking Id from Booking:$bookingId');
                  },
                ),
                ListTile(
                  leading: FaIcon(
